...
const Dashboards = () => {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            fetch("http://127.0.0.1:5001/check-changes")
        ...
        <div className="chart">
            ...
            <div id="chart-4" className="dashboard-container">
                ...
                <iframe
                    ...
                    data-src="https://wired-comic-monkfish.ngrok-free.app/superset/explore/p/MnZX8pMXeYp/?standalone=1&height=400"
                    width="600"
                    height="400"
                    seamless
                    frameBorder="0"
                    scrolling="no"
                    src="https://wired-comic-monkfish.ngrok-free.app/superset/explore/p/MnZX8pMXeYp/?standalone=1&height=400"
                ></iframe>
            </div>
