        ...
        <div className="home">
            <div className="home-container">
                ...
                <div className="results-header">
                    ...
                    <p>
                        Hiện có <strong>{products.length}</strong> kết quả trên tổng số <strong>{totalPages}</strong>{" "}
                        trang.
                    </p>
                </div>
                        ...
                        return (
                            <div key={product.id} className="product-card">
                                ...
                                <div className="product-details">
                                    ...
                                    <p className="product-price">{product.price.toLocaleString("vi-VN")} triệu/tháng</p>
